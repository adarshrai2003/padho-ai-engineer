...
- Experience with at least one general-purpose programming language such as Java, Python, C++, C#, Go, Rust, javascript, reactjs, nodejs, expressjs, or Typescript.
...
for file_path in resume_folder.iterdir():
    #~/padho-ai-engineer/Mini-project/Resumes/Adarsh3_resume_.pdf
